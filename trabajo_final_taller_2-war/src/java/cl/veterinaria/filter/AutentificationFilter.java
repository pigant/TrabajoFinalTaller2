 ...
 */
package cl.veterinaria.filter;

import cl.veterinaria.bean.LoginBean;
 ...
 * @author Sistemas
 */
@WebFilter(filterName = "AutentificationFilter", urlPatterns = {"*.xhtml"})
public class AutentificationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            if (((HttpServletRequest)request).getRequestURL().equals("login.xhtml")){
                
            }
            if(this.loginBean.getUsuarios() != null){
